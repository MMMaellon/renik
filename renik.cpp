...
void RenIK::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Skeleton"), "set_skeleton_path", "get_skeleton_path_name");

	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Head Bone"), "set_head_bone", "get_head_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::POOL_STRING_ARRAY, "Neck Bones"), "set_neck_bones", "get_neck_bones_names");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Shoulder Left Bone"), "set_shoulder_left_bone", "get_shoulder_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Upper Arm Left Bone"), "set_upper_arm_left_bone", "get_upper_arm_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Forearm Left Bone"), "set_forearm_left_bone", "get_forearm_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Hand Left Bone"), "set_hand_left_bone", "get_hand_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Shoulder Right Bone"), "set_shoulder_right_bone", "get_shoulder_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Upper Arm Right Bone"), "set_upper_arm_right_bone", "get_upper_arm_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Forearm Right Bone"), "set_forearm_right_bone", "get_forearm_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Hand Right Bone"), "set_hand_right_bone", "get_hand_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::POOL_STRING_ARRAY, "Spine Bones"), "set_spine_bones", "get_spine_bones_names");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Hip Bone"), "set_hip_bone", "get_hip_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Thigh Left Bone"), "set_thigh_left_bone", "get_thigh_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Shin Left Bone"), "set_shin_left_bone", "get_shin_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Foot Left Bone"), "set_foot_left_bone", "get_foot_left_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Thigh Right Bone"), "set_thigh_right_bone", "get_thigh_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Shin Right Bone"), "set_shin_right_bone", "get_shin_right_bone_name");
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "Foot Right Bone"), "set_foot_right_bone", "get_foot_right_bone_name");

	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Head Target"), "set_head_target_path", "get_head_target_path_name");
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Left Hand Target"), "set_hand_left_target_path", "get_hand_left_target_path_name");
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Right Hand Target"), "set_hand_right_target_path", "get_hand_right_target_path_name");
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Hip Target"), "set_hip_target_path", "get_hip_target_path_name");
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Left Foot Target"), "set_foot_left_target_path", "get_foot_left_target_path_name");
	ADD_PROPERTY(PropertyInfo(Variant::NODE_PATH, "Right Foot Target"), "set_foot_right_target_path", "get_foot_right_target_path_name");
